...
\begin{center}
    % Project Title
    {\Huge \bfseries PCON's Annual Machine Learning \\[0.5cm]Hackathon '26}
...
Welcome to \textbf{PCON’s Annual Machine Learning Hackathon ’26}, a 36-hour
challenge.
...
\begin{enumerate}
    ...
    \item Create a \textbf{new GitHub repository} for the hackathon submission, and all work must be original.
...
\begin{enumerate}
    ...
    \item Participants cannot make more than \textbf{3 submissions}.
...
Use eval.csv (it contains 10K entries with the above qualities). Submit your predictions as a single CSV file with exactly 10,000 lines of binary output.
