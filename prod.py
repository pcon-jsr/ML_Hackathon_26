...
app.config["SESSION_COOKIE_SECURE"] = True  # Forces HTTPS-only cookies
app.config["MAX_CONTENT_LENGTH"] = 1 * 1024 * 1024  # 1MB file upload limit
...
if __name__ == "__main__":
    app.run(host="0.0.0.0", port=int(os.environ.get("PORT", 2026)), debug=False)
